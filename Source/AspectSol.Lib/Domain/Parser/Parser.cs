...
public class Parser : AbstractParser, IParser
{
    ...
    private AppendStatementNode MatchStatementAppend()
    {
        ...
        return new AppendStatementNode
        {
            Location  = location,
            Placement = placement,
            Selectors = selectors,
    ...
    private PlacementNode MatchPlacement()
    {
        ...
        if (LookaheadFirst.TokenType == TokenType.Before) placement     = new BeforePlacementNode();
        else if (LookaheadFirst.TokenType == TokenType.After) placement = new AfterPlacementNode();
    ...
    private ModificationStatementNode MatchStatementModification()
    {
    ...
    private WildcardSelectorNode MatchSelectorWildcard(WildcardFor wildcardFor)
    {
